...
export class PerfectScrollbarDirective implements OnChanges, OnInit, OnDestroy {
    readonly perfectScrollbar = model<any>(true);
    readonly perfectScrollbarOptions = input<PerfectScrollbar.Options>({
    ...
    ngOnChanges(changes: SimpleChanges): void {
        ...
        if ('perfectScrollbar' in changes) {
            ...
            this.perfectScrollbar.set(coerceBooleanProperty(changes.perfectScrollbar.currentValue));
        ...
        if ('perfectScrollbarOptions' in changes) {
            // Merge the options
            this._options = { ...this._options, ...changes.perfectScrollbarOptions.currentValue };
    ...
    private _init(): void {
        ...
        if (this._platform.ANDROID || this._platform.IOS || !this._platform.isBrowser) {
            this.perfectScrollbar.set(false);
            return;
        }
